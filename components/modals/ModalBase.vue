    ...
    <TransitionRoot as="template" :show="open">
        <Dialog class="relative z-10" @close="handleClose">
            ...
            <div class="modal fixed inset-0 z-10 w-screen overflow-y-auto">
                <div
                    class="modal__inner flex min-h-full items-end justify-center p-4 sm:items-center sm:p-0"
                >
                    <TransitionChild
                        as="template"
                        enter="ease-out duration-300"
                    ...
                    >
                        ...
                        >
                            <div
                                v-if="showHeader"
                                class="modal__header"
                                :style="{ marginBottom: headerMarginBottom + 'px' }"
                            >
                            ...
                            <div
                                v-if="showBody"
                                class="modal__body"
                                :style="{ marginBottom: bodyMarginBottom + 'px' }"
                            >
                                <slot name="body"></slot>
                            </div>
                            ...
                            <div
                                v-if="showFooter"
                                class="modal__footer flex items-center justify-end"
                            >
...
.modal {
    &__content {
        width: min(520px, calc(100vw - #{$spacing-xl}));
        max-height: calc(100dvh - #{$spacing-xl});
        padding: $spacing-xxl $spacing-xl;
        border-radius: $spacing-md;
        background: $color-white;
        box-shadow: 0 4px 16px 2px rgba(168, 185, 193, 0.2);
        overflow-y: auto;
    }
...
@media (max-width: 767px) {
    .modal {
        ...
        &__content {
            width: 100%;
            max-height: calc(100dvh - #{$spacing-lg});
